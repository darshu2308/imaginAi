...
const socialProfiles = {
    ...
    facebook: 'darshan2308',  
    linkedin: 'DarshanPatel'   
};
...
function setupGalleryLink() {
    const galleryLink = document.getElementById('create');
    if (!galleryLink) {
        console.error('Gallery link not found');
        return;
    }
    ...
    galleryLink.addEventListener('click', function(event) {
        ...
        const targetElement = document.querySelector('#targetElement'); // Replace with your actual gallery section ID
        if (!targetElement) {
            console.error('Gallery section not found');
            return;
        }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function nextSlide() {
      ...
      currentImage.classList.remove('animate-slideInRight');
      currentImage.classList.add('animate-slideOutLeft');

      setTimeout(() => {
        currentImage.style.opacity = '0';
        currentImage.classList.remove('animate-slideOutLeft');
        currentImage.style.transform = 'translateX(-100%)';

        nextImage.style.opacity = '1';
        nextImage.style.transform = 'translateX(0)';
        nextImage.classList.add('animate-slideInRight');
